...
protocol CoreDataConnect{
    var myContext: NSManagedObjectContext { get set };
    
    init(context: NSManagedObjectContext);
    
    func insert(_ myEntityName:String, attributeInfo:[String:String]) -> Bool;
    func select(_ myEntityName:String, predicate:String?, sort:[[String:Bool]]?, limit:Int?) -> [NSManagedObject]?;
...
extension CoreDataConnect{
    ...
    // update
    func update(_ myEntityName:String, predicate:String?, attributeInfo:[String:String]) -> Bool {
        if let results = self.select(myEntityName, predicate: predicate, sort: nil, limit: nil) {
